...
wysihtml5.polyfills = function(win, doc) {
    ...
    if (!Array.prototype.indexOf) {
        Array.prototype.indexOf = function(a, f) {
            for (var c = this.length, r = -1, d = f >>> 0;~
                (c - d); r = this[--c] === a ? c : r);
            return r;
        };
    }
...
(function(dom) {
    ...
    function resolveList(list, useLineBreaks) {
        ...
        var doc = list.ownerDocument,
            ...
            nextSibling = wysihtml5.dom.domNode(list).next({
                ignoreBlankTexts: true
            }),
            firstChild,
            lastChild,
        ...
        /** @scope wysihtml5.Selection.prototype */
        {
            ...
            getPreviousNode: function(node, ignoreEmpty) {
                ...
                if (ret && ret.nodeType !== 3 && ret.nodeType !== 1) {
                    ...
                    if (!wysihtml5.lang.array(["BR", "HR", "IMG"]).contains(ret.nodeName) && !wysihtml5.lang.array(["block", "inline-block", "flex", "list-item", "table"]).contains(displayStyle) &&
            ...
            getBeforeSelection: function(includePrevLeaves) {
                ...
                inTmpCaret = wysihtml5.dom.getParentElement(startNode, {
                    query: '._wysihtml5-temp-caret-fix'
                }, 1);
                if (inTmpCaret) {
...
(function(wysihtml5) {
    ...
    function getOptions(value) {
        ...
        return wysihtml5.lang.object({}).merge(nodeOptions).merge({
            'attribute': value
        }).get();
    }
    ...
    wysihtml5.commands.formatBlock = {
        ...
        state: function(composer, command, properties) {
            ...
            for (var i = 0, maxi = parentNodes.length; i < maxi; i++) {
                parent = dom.getParentElement(parentNodes[i], properties || {
                    query: BLOCK_ELEMENTS
                }, null, composer.element);
...
(function(wysihtml5) {
    ...
    function updateFormatOfElement(element, options) {
        ...
        nodeQueryMatch = nodeNameQuery ? wysihtml5.dom.domNode(element).test({
            query: nodeNameQuery
        }) : false;
    ...
    var fixLastBrDeletionInTable = function(composer, force) {
        if (composer.selection.caretIsLastInSelection()) {
            var sel = composer.selection.getSelection(),
                aNode = sel.anchorNode;
            if (aNode && aNode.nodeType === 1 && (wysihtml5.dom.getParentElement(aNode, {
                query: 'td, th'
